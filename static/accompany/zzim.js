document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll(".zzim-btn").forEach(button => {
      button.addEventListener("click", zzimClickHandler);
  });
});

function zzimClickHandler() {
  const travelId = this.dataset.travelId;

  fetch(`/accompany/toggle-zzim/${travelId}/`, {
      method: "POST",
      headers: {
